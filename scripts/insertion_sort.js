...
function Insertion()
{
    ...
    document.getElementById("Time_Average").innerText="ON^2)";
    document.getElementById("Time_Best").innerText="O(N)";

    //Setting Space complexity
    document.getElementById("Space_Worst").innerText="O(1)";
    document.getElementById("Space_Average").innerText="O(1)";
    document.getElementById("Space_Best").innerText="O(1)";
